...
/// er net zo goed in; dan raadt de bibliotheek de gebeurtenisnaam uit de categorie.
/// </remarks>
public static class AgentLoggerExtensions
{
    ...
    /// <param name="extra">Vrije context, uitklapbaar op het scherm. Mag een anoniem object zijn.</param>
    ...
    /// <param name="extra">Vrije context, uitklapbaar op het scherm.</param>
